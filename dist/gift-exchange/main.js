...
var SetupService = /** @class */ (function () {
                                            ...
                                            return __generator(this, function (_c) {
                                                switch (_c.label) {
                                                    case 0:
                                                        ...
                                                        return [4 /*yield*/, this.db.updateExchange(this.setupData.uid, { 'adminUid': exId })];
                                                    case 1:
                                                        _c.sent();
                                                        return [4 /*yield*/, true];
                                                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        admin = { 'name': this.setupData.adminName, 'email': this.setupData.adminEmail };
    ...
    SetupService.prototype.checkData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                goodData = true;
                list = ['name', 'date', 'budget', 'exchangees', 'adminName', 'adminEmail'];
...
module.exports = __webpack_require__(/*! /Users/jheister/sites/gift-exchange/src/main.ts */"./src/main.ts");
